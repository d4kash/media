  ...
  Widget build(BuildContext context) {
    FlickManager flickManager = FlickManager(
        videoPlayerController: VideoPlayerController.networkUrl(
            Uri.parse(widget.videoDetails.sources.first)));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      textScaler: MediaQuery.textScalerOf(context),
                      widget.videoDetails.description,
                      style: TextStyle(
                        ...
                        children: [
                          CircleAvatar(
                            foregroundImage: NetworkImage(
                                '${Constant.image_base_url}/${widget.videoDetails.thumb}'),
                            backgroundColor: const Color(0xffD0A2F7),
                          ),
                          SizedBox(
                            width: Constant.width / 35,
                          ),
                          Text(
                            textScaler: MediaQuery.textScalerOf(context),
                            widget.videoDetails.subtitle,
                            style: TextStyle(
                          ...
                          // ElevatedButton(
                          //     onPressed: () {
                          //       DownloadFunctions().downloadRecording(
                          //           widget.videoDetails.sources.first);
                          //     },
